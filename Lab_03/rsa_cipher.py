...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_encrypt.clicked.connect(self.call_api_gen_encrypt)
        self.ui.btn_decrypt.clicked.connect(self.call_api_gen_decrypt)
